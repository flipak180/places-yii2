...
<header class="header">
    <div class="container">
        <a class="logo" href="/"><img src="/places-markup/dist/img/logo.png" srcset="/places-markup/dist/img/logo@2x.png 2x" alt="Кальянные.рф"></a>
        <nav>
        ...
        <div class="buttons">
            <a class="btn btn-primary btn-upper popup-link" href="#signup-modal">Добавить заведение</a>
            <?php if (Yii::$app->user->isGuest): ?>
                <a class="btn btn-default popup-link" href="#login-modal">
                    <span>Войти</span>
...
<div class="sticky-header">
    <div class="container">
        <a class="logo" href="/"><img src="/places-markup/dist/img/logo2.png" srcset="/places-markup/dist/img/logo2@2x.png 2x" alt="Кальянные.рф"></a>
        <div class="menu">
            ...
            <div class="overlay">
                <a href="#">
                    <svg width="20" height="16" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M0 15a1 1 0 0 1 1-1h18a1 1 0 1 1 0 2H1a1 1 0 0 1-1-1zM0 1a1 1 0 0 1 1-1h18a1 1 0 1 1 0 2H1a1 1 0 0 1-1-1zM0 8a1 1 0 0 1 1-1h18a1 1 0 1 1 0 2H1a1 1 0 0 1-1-1z" fill="#5B114E"/></svg>
                    Меню
                </a>
                <nav>
                    <a href="/place-card.html">TOP10</a>
