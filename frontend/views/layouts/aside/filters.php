...
<?php $form = ActiveForm::begin([
    ...
    <div class="box comforts-filter">
        <div class="body">
            <?= Html::activeCheckboxList($model, 'comforts_field', Comfort::getList(), [
                'item' => function ($index, $comfort, $name, $checked, $value) {
                    $checked = $checked ? 'checked="checked"' : '';
                    return "<div class=\"form-row checkbox-row\">
                                <label for=\"comfort-{$value}\">
                                    <input type=\"checkbox\" name=\"{$name}\" value=\"{$value}\" id=\"comfort-{$value}\" {$checked}>
