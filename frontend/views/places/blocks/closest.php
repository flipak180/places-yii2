...
<div class="places">
    <h3>Ближайшие заведения</h3>
    <div class="list">
        <?php foreach ($model->closest as $place): ?>
            <div class="item">
                <div class="main" style="background-image: url(<?= $model->mainImage ?>)">
