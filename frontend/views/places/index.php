...
<!--<div class="places">
    ...
    <div class="list">
        <div class="item">
            <div class="main" style="background-image: url(/places-markup/dist/uploads/place-1.jpg)">
        ...
        <div class="item">
            <div class="main" style="background-image: url(/places-markup/dist/uploads/place-2.jpg)">
...
<div class="reviews">
    ...
    <div class="item">
        <div class="author"><img class="responsive" src="/places-markup/dist/img/no-avatar.png" alt="">
            <h4>Роман</h4>
    ...
    <div class="item">
        <div class="author"><img class="responsive" src="/places-markup/dist/uploads/avatar-1.png" alt="">
            <h4>Марина</h4>
            <p>Критик 1-го уровня</p>
        </div>
        <div class="main">
    ...
    <div class="item">
        <div class="author"><img class="responsive" src="/places-markup/dist/uploads/avatar-2.png" alt="">
            <h4>Татьяна</h4>
...
<h1>Кальянные <?= Yii::$app->city->current->padezh_rodit ?></h1>
<?= Yii::$app->city->current->seo_text ?>
